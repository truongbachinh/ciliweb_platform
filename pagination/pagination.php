...
<!-- <?php
        if ($currentPage > 2) {
            $firstPage = 1;
        ?>
    <a class="page-item" href="?per_page=<?= $pPerPage ?>&page=<?= $firstPage ?>">First</a>
<?php
        }
?>
...
if ($currentPage > 1) {
    $prevPage = $currentPage - 1;
?>
    <a class="page-item" href="?per_page=<?= $pPerPage ?>&page=<?= $prevPage ?>">Prev</a>
<?php
}
?>
...
?>
    <?php if ($num != $currentPage) { ?>
        <a class="page-item" href="?per_page=<?= $pPerPage ?>&page=<?= $num ?>"><?= $num ?></a>
    <?php
    } else {
    ?>
...
?>
    <a class="page-item" href="?per_page=<?= $pPerPage ?>&page=<?= $nextPage ?>">Next</a>
<?php
}
?>
...
if ($currentPage < $totalPage - 3) {
    $endPage = $totalPage;
?>
    <a class="page-item" href="?per_page=<?= $pPerPage ?>&page=<?= $endPage ?>">Last</a>
<?php
}
?> -->