...
<body class="sidebar-pinned ">
        ...
        <?php if (isset($userId) == true) : ?>
            <section class="admin-content">
                <div class="container m-t-30">
                                ...
                                <div class="modal-body">
                                    <div class="wrapper">
                                        <section class="chat-area">
                                            <header>
                                                <a href="./talk_to_user.php" class="back-icon" onclick="turnOfInterval()"><i class="fas fa-arrow-left"></i></a>
                    ...
                    <script src="../shop/javascript/talk_to_user.js"></script>
            </section>
        <?php else : ?>
            <?php
            header('location: ../account/login.php');
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function(e) {
            ...
            $(document).on('click', '.btn-chat-user', function(e) {
                ...
                Utils.api('get_user_coversation_detail', {
                    id: userId
                }).then(response => {
    ...
    <script src="../shop/javascript/conversation.js"></script>
