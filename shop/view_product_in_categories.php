                                ...
                                <div class="table-responsive p-t-10">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 1;
                                            $result = $link->query("SELECT products.*, categories.*,shop.* from products INNER JOIN categories ON products.p_category_id = categories.ctg_id INNER JOIN shop ON products.p_shop_id = shop.shop_id where categories.ctg_id = '$idCtg' AND shop.shop_id = '$shopId' ");
                                            if (!empty($result)) {
