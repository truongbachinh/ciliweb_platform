<!-- <?php
        ...
        ?>
<div id="testAjax" style="width:1000px">
    <form action="cart.php?view=update_cart" method="post" enctype="multipart/form-data">
        ...
        <br>
        <hr>
        <div class="totalCost" style="display: flex;">
            <div>
                <?php
                if (!empty($total)) {
                ?>
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <div>
                <input type="submit" class="btn btn-success" name="add_to_order" value="Order normal"></input>
            </div>
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <div>
        ...
        <div id="orderForm">
            ...
            <div>
                <input type="submit" class="btn btn-success" name="order_button" value="order normal"></input>
            </div>
