                    ...
                    if ($secureHash == $vnp_SecureHash) {
                        if ($_GET['vnp_ResponseCode'] == '00') {
                            ...
                            if ($row > 0) {
                                ...
                                $sql = "INSERT INTO payments(order_id, member, money, note, vnp_response_code, code_vnpay, code_bank, time) VALUES ('$order_id', '$taikhoan', '$money', '$note', '$vnp_response_code', '$code_vnpay', '$code_bank','$date_time')";
                                mysqli_query($conn, $sql);
                            }
