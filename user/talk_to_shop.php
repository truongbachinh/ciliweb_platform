<section class="admin-content">
    <div class="container m-t-30">
                    ...
                    <div class="modal-body">
                        <div class="wrapper">
                            <section class="chat-area">
                                <header>
                                    <a href="../user/index.php?view=conversation" onclick="turnOfInterval()" class="back-icon"><i class="fas fa-arrow-left"></i></a>
        ...
        <script src="../user/javascript/talk_to_shop.js"></script>
</section>