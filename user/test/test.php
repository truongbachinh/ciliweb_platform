    ...
    <div class="row container">
        <div class="col-md-4 ">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <h3 style="alige:center"><b><?php echo round($AVGRATE, 1); ?></b> <i class="fa fa-star" data-rating="2" style="font-size:20px;color:#ff9f00;"></i></h3>
                ...
                <div class="col-md-6">
                    ...
                    ?>
                        <h4 style="alige:center"><?= $db_rating['ratinsg']; ?> <i class="fa fa-star" data-rating="2" style="font-size:20px;color:green;"></i> Total <?= $db_rating['Total']; ?></h4>
